...
public class ExtsalesTestContainer extends TestContainer {

    public ExtsalesTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/extsales/app.properties",
    ...
    public static class Common extends ExtsalesTestContainer {

        public static final ExtsalesTestContainer.Common INSTANCE = new ExtsalesTestContainer.Common();
